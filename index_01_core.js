...
const PLATAFORMAS = {
  ...
  disneys:     { key: "disneys",     nombre: "Disney Premium sin ESPN", categoria: "video",     acceso: "correo_clave_pin", capacidadDefault: 3,  requiereCorreo: true,  requiereClave: true,  requierePin: true,  permiteUsuario: false },
  ...
  viki:        { key: "viki",        nombre: "Viki Rakuten",    categoria: "video",     acceso: "correo_clave",     capacidadDefault: 1,  requiereCorreo: true,  requiereClave: true,  requierePin: false, permiteUsuario: false },
  appletv:     { key: "appletv",     nombre: "Apple TV",        categoria: "video",     acceso: "correo_clave_pin", capacidadDefault: 4,  requiereCorreo: true,  requiereClave: true,  requierePin: true,  permiteUsuario: false },
  ...
  stellatv1:   { key: "stellatv1",   nombre: "Stella TV (1 dispositivo)", categoria: "iptv", acceso: "usuario_clave", capacidadDefault: 1, requiereCorreo: false, requiereClave: true, requierePin: false, permiteUsuario: true  },
  stellatv2:   { key: "stellatv2",   nombre: "Stella TV (2 dispositivos)", categoria: "iptv", acceso: "usuario_clave", capacidadDefault: 2, requiereCorreo: false, requiereClave: true, requierePin: false, permiteUsuario: true  },
  stellatv3:   { key: "stellatv3",   nombre: "Stella TV (3 dispositivos)", categoria: "iptv", acceso: "usuario_clave", capacidadDefault: 3, requiereCorreo: false, requiereClave: true, requierePin: false, permiteUsuario: true  },
