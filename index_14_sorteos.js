...
async function registrarEventoSorteos(rawEvent={}){
  ...
  const clientId=safeId(rawEvent.clientId),eventId=clean(rawEvent.eventoId,500);
...
module.exports={DEFAULT_RULES,registrarEventoSorteos,registrarEventoSorteosSeguro};
